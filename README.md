...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=html,css,js,ts,react,redux,nextjs,
      tailwind,sass,vite,gulp,
      firebase,postman,mongodb,
      git,github,gitlab,npm,nodejs,express,
      vscode,devto,
      ps,figma,svg,
      stackoverflow,vercel," />
  </a>
</p>
